...
export const PERSONAL_INFO: PersonalInfo = {
  ...
  linkedin: 'https://www.linkedin.com/in/nguyen1oc/',
  facebook: 'https://www.facebook.com/nnnguyen.loc/',
...
export const PHOTOS: PhotoItem[] = [
  {
    ...
    localPath: '/images/photography/photo_1.jpg',
  ...
  },
  {
    ...
    localPath: '/images/photography/photo_2.jpg',
  ...
  },
  {
    ...
    localPath: '/images/photography/photo_3.jpg',
  ...
  },
  {
    ...
    localPath: '/images/photography/photo_4.jpg',
  ...
  },
  {
    ...
    localPath: '/images/photography/photo_5.jpg',
  ...
  },
  {
    ...
    year: '2024',
    caption: 'Interplay of street light, movement, and city rhythm.',
    story: 'Capturing dynamic urban flow through the lens.',
    cameraInfo: 'Sony A7 IV • 35mm f/1.8 • 1/320s ISO 200',
    localPath: '/images/photography/photo_6.jpg',
  ...
  },
  {
    ...
    year: '2024',
    caption: 'Vintage architecture bearing the colors of time.',
    story: 'Exploring historical alleys and preserved cultural architectures.',
    cameraInfo: 'Fujifilm X-T30 II • 35mm f/2 • 1/200s ISO 250',
    localPath: '/images/photography/photo_7.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1477959858617-67f30bc75b82?w=600&auto=format&fit=crop&q=80',
  },
  {
    id: 'p8',
    ...
    year: '2024',
    caption: 'Warm reflections gliding across the rippling water surface.',
    story: 'Watching the day wind down from the river bank.',
    cameraInfo: 'Sony A7 IV • 50mm f/1.4 • 1/500s ISO 100',
    localPath: '/images/photography/photo_8.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?w=600&auto=format&fit=crop&q=80',
  },
  {
    id: 'p9',
    ...
    location: 'Ho Chi Minh City',
    year: '2024',
    caption: 'High contrast light and architectural depth.',
    story: 'Finding pure shapes and shadows in everyday structures.',
    cameraInfo: 'Fujifilm X-T30 II • 23mm f/1.4 • 1/400s ISO 200',
    localPath: '/images/photography/photo_9.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&auto=format&fit=crop&q=80',
  },
  {
    id: 'p10',
    title: 'Twilight Motion',
    location: 'District 1, Ho Chi Minh City',
    year: '2024',
    caption: 'Light trails tracing through the evening rush.',
    story: 'Long exposure street capture of metropolitan vitality.',
    cameraInfo: 'Sony A7 IV • 24mm f/2.8 • 1/60s ISO 400',
    localPath: '/images/photography/photo_10.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1508739773434-c26b3d09e071?w=600&auto=format&fit=crop&q=80',
  },
  {
    id: 'p11',
    ...
    location: 'Ho Chi Minh City',
    year: '2024',
    caption: 'A serene corner in the heart of a bustling city.',
    story: 'Documenting still moments in quiet urban pockets.',
    cameraInfo: 'Fujifilm X-T30 II • 35mm f/2 • 1/250s ISO 160',
    localPath: '/images/photography/photo_11.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?w=600&auto=format&fit=crop&q=80',
  },
];
...
export const MOVIES: MovieItem[] = [
  ...
  },
  {
    ...
    releaseYear: 2010,
    category: 'Drama & Tech Biography',
    quote: 'A million dollars isn’t cool. You know what is cool? A billion dollars.',
    localPath: '/images/movies/social_network.jpg',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/en/8/8c/The_Social_Network_poster.png',
  },
  {
    id: 'm8',
    ...
    releaseYear: 2014,
    category: 'Biography & AI Computing',
    quote: 'Sometimes it is the people no one can imagine anything of who do the things no one can imagine.',
    localPath: '/images/movies/imitation_game.jpg',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/en/5/5e/The_Imitation_Game_poster.jpg',
  },
  {
    id: 'm9',
    ...
    localPath: '/images/movies/truman_show.jpg',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/en/c/cd/Trumanshow.jpg',
  },
  {
    id: 'm10',
    title: 'The Matrix',
    ...
    localPath: '/images/movies/matrix.jpg',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/en/c/c1/The_Matrix_Poster.jpg',
  },
  {
    id: 'm11',
    title: 'Dune: Part One',
    ...
    localPath: '/images/movies/dune_part1.jpg',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/en/8/8e/Dune_%282021_film%29.jpg',
  },
  {
    id: 'm12',
    title: 'Dune: Part Two',
    ...
    localPath: '/images/movies/dune_part2.jpg',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/en/5/52/Dune_Part_Two_poster.jpeg',
  },
  {
    id: 'm13',
    title: 'Parasite',
    ...
    localPath: '/images/movies/parasite.jpg',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/en/5/53/Parasite_%282019_film%29.png',
  },
  {
    id: 'm14',
    title: 'La La Land',
    ...
    localPath: '/images/movies/lalaland.jpg',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/en/a/ab/La_La_Land_%28film%29.png',
  },
  {
    id: 'm15',
    title: '2012',
    ...
    quote: 'The moment we stop fighting for each other, that’s the moment that we lose our humanity.',
    localPath: '/images/movies/movie_2012.jpg',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/en/e/e0/2012_poster.jpg',
  },
  {
    id: 'm16',
